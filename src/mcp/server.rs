...
use rmcp::{
    ...
    model::{ServerCapabilities, ServerInfo, CallToolResult, Content, Tool},
...
impl ElevenLabsMcpServer {
    ...
    fn handle_tool(&self, name: &str, _args: &serde_json::Map<String, serde_json::Value>) -> Result<CallToolResult, McpError> {
    ...
    fn get_info(&self) -> ServerInfo {
        ServerInfo {
            instructions: Some(
                ...
                Samples, Tools, Audio Native, Voice Design, Fine-tuning.".into()
            ),
...
pub fn list_tools() -> Vec<&'static str> {
    vec![
        // TTS & Audio
        "text_to_speech", "speech_to_text", "generate_sfx", "audio_isolation", "voice_changer",
        // Voice Management  
        "list_voices", "get_voice", "delete_voice", "clone_voice", "voice_settings", "edit_voice_settings",
        "create_voice_design", "get_voice_design", "start_voice_fine_tune", "get_voice_fine_tune_status",
        "cancel_voice_fine_tune", "share_voice", "get_similar_voices",
        // Dubbing
        "create_dubbing", "get_dubbing_status", "delete_dubbing",
        // History
        "list_history", "get_history_item", "delete_history_item", "history_feedback", "download_history",
        // Agents
        "list_agents", "get_agent_summaries", "create_agent", "get_agent", "update_agent", "delete_agent",
        "agent_branches", "batch_list",
        // User
        "get_user_info", "get_user_subscription",
        // Models
        "list_models", "get_model_rates",
        // Usage
        "get_usage",
        // Knowledge
        "list_knowledge", "add_knowledge", "delete_knowledge",
        // RAG
        "create_rag", "get_rag_status", "delete_rag", "rebuild_rag", "get_rag_index_status",
        // Webhooks
        "list_webhooks", "create_webhook", "delete_webhook",
        // Dialogue
        "create_dialogue",
        // Library
        "list_library_voices", "list_library_collections",
        // Pronunciation
        "list_pronunciations", "add_pronunciation", "delete_pronunciation",
        "list_pronunciation_rules", "add_pronunciation_rules", "remove_pronunciation_rules", "get_pronunciation_pls",
        // Workspace
        "workspace_info", "list_workspace_members", "list_workspace_invites", "invite_workspace_member",
        "revoke_workspace_invite", "list_workspace_api_keys", "list_secrets", "add_secret", "delete_secret",
        "share_workspace",
        // Phone
        "list_phones", "get_phone", "import_phone", "update_phone", "delete_phone", "test_phone_call",
        // Conversation
        "converse_chat", "list_conversations", "get_conversation", "get_signed_url", "get_conversation_token",
        "delete_conversation", "get_conversation_audio",
        // Projects
        "list_projects", "get_project", "delete_project", "convert_project", "list_project_snapshots", "get_project_audio",
        // Music
        "generate_music", "list_music", "get_music", "download_music", "delete_music",
        // Samples
        "list_samples", "delete_sample",
        // Tools
        "list_tools", "get_tool", "delete_tool",
        // Audio Native
        "list_audio_native", "get_audio_native", "create_audio_native",
    ]
}
